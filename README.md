...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-shinymanager-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13990&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-shinymanager-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-shinymanager` can be installed with:

```
conda install r-shinymanager
```

It is possible to list all of the versions of `r-shinymanager` available on your platform with:
